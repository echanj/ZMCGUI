...
ZMC --crystal --diffuse ACSALA07_relabel_ZMC.inp form1


DZMC form1.diffuse < input_diffuse_h0l  
~/bin/bin2gray  --twofold --norm=20000 h0l.bin 
mv h0l.pgm pgm/h0l.pgm
rm h0l.bin 

DZMC form1.diffuse < input_diffuse_hk0  
~/bin/bin2gray --hmirror -vmirror  --norm=20000 hk0.bin 
mv hk0.pgm pgm/hk0.pgm
rm hk0.bin 

DZMC form1.diffuse < input_diffuse_0kl  
~/bin/bin2gray --hmirror -vmirror  --norm=20000 0kl.bin 
...
sed '11 s/8,15,8/8,15,8/' $temp > $temp2
sed '12 s/1/1/' $temp2 > $temp3
sed '13 s/8/52/' $temp3 > $temp4
